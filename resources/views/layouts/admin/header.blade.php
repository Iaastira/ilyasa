							...
							<div class="row">
								...
								<div class="col">
									<figure class="tint">
										...
										<img src="/admin/assets/img/demos/ecom-header.jpg" alt="">
									</figure>
								</div>
							</div>
						</div>
				...
				<ul class="navbar-nav nav-right">
					...
					<li class="nav-item dropdown">
						<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
							<img src="/admin/assets/img/avatars/1.jpg" class="w-35 rounded-circle" alt="Albert Einstein">
						</a>
						<div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
							<div class="dropdown-header pb-3">
								<div class="media d-user">
									<img class="align-self-center mr-3 w-40 rounded-circle" src="/backend/assets/img/avatars/1.jpg" alt="Bacem">
						...
						<a class="dropdown-item" href="pages.profile.html"><i class="icon dripicons-user"></i> Profile</a>
							...
							<a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                        ...
                                        <i class="icon dripicons-lock"></i>{{ __('Logout') }}
                                    </a>
