					...
					<ul class="site-logo">
						...
						<!-- START LOGO -->
							<a href="index-2.html">
								...
								<span class="brand-text">SMK Assalaam</span>
							</a>
						<!-- END LOGO -->
						</li>
					</ul>
					...
					<ul class="nav metismenu">
						...
						<li class="nav-dropdown active">
							...
							<ul class="collapse in nav-sub" aria-expanded="true">
								<li class="active"><a href="{{ url('/game') }}"><span>Game</span></a></li>
								<li><a href="{{ url('/genre') }}"><span>Genre</span></a></li>
								<li><a href="{{ url('/developer') }}"><span>Developer</span></a></li>
