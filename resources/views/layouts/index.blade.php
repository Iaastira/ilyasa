            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container-fluid">
                    ...
                    <nav class="classy-navbar justify-content-between" id="nikkiNav">
                        ...
                        <!-- Nav brand -->
                        <a href="layouts/index.php" class="nav-brand"><img src="{{ asset ('assets/frontend/img/core-img/logo.png') }}" alt=""></a>
    ...
    <section class="hero-area">
        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="background-image: url(assets/frontend/img/blog-img/cc.jpg);"></div>
                <!-- Post Content -->
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="{{ asset('assets/frontend/background-image: url(img/blog-img/14.jpg)')}};"></div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
                        <p class="post-date" data-animation="fadeIn" data-delay="100ms">MAY 01, 2018 / lifestyle</p>
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="{{ asset('assets/frontend/background-image: url(img/blog-img/15.jpg)')}};"></div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
                        <p class="post-date" data-animation="fadeIn" data-delay="100ms">MAY 01, 2018 / lifestyle</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="featured-post-area mb-50">
                                    ...
                                    <div class="post-thumbnail mb-30">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/12.jpg') }}" alt=""></a>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/1.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/2.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/3.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/4.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/5.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                                        <p class="p ost-date">MAY 29, 2018 / food</p>
                                        <a href="#" class="post-title">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/6.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                    ...
                    <div class="post-sidebar-area">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="about-thumbnail">
                                <img src="{{ asset ('assets/frontend/img/blog-img/about-me.jpg') }}" alt="">
                            </div>
                            <!-- Content -->
                            <div class="widget-content text-center">
                                <img src="{{ asset ('assets/frontend/img/core-img/signature.png') }}" alt="">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{ asset ('assets/frontend/img/blog-img/lp1.jpg') }}" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{ asset ('assets/frontend/img/blog-img/lp2.jpg') }}" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{ asset ('assets/frontend/img/blog-img/lp3.jpg') }}" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{ asset ('assets/frontend/img/blog-img/lp4.jpg') }}" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{ asset ('assets/frontend/img/blog-img/lp5.jpg') }}" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                        ...
                        <div class="single-widget-area mb-30">
                            <!-- Adds -->
                            <a href="#"><img src="{{ asset ('assets/frontend/img/blog-img/add.png') }}" alt=""></a>
                        </div>
    ...
    <div class="follow-us-instagram">
        <div class="instagram-content d-flex flex-wrap align-items-center">
            ...
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta1.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta2.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta3.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta4.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta5.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta6.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta7.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>

            <!-- Single Instagram Slide -->
            <div class="single-instagram">
                <img src="{{ asset ('assets/frontend/img/blog-img/insta8.jpg') }}" alt="">
                <a href="#"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
