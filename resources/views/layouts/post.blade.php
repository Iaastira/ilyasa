                    ...
                    <div class="single-post-details-area">
                        <div class="post-content">
                            ...
                            <div class="post-thumbnail mb-50">
                                <img src="{{asset('assets/frontend/img/blog-img/8.jpg')}}" alt="">
                            </div>
                            ...
                            <div class="post-text">
                                ...
                                <blockquote class="shortcodes">
                                    <div class="blockquote-icon">
                                        <img src="{{asset('assets/frontend/img/core-img/quote.png')}}" alt="">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <img class="mb-30" src="{{asset('assets/frontend/img/blog-img/4.jpg')}}" alt="">
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <img class="mb-30" src="{{asset('assets/frontend/img/blog-img/3.jpg')}}" alt="">
                                    </div>
                                </div>
                                    ...
                                    <ol>
                                        ...
                                        <li class="single_comment_area">
                                            <div class="comment-wrapper d-flex">
                                                ...
                                                <div class="comment-author">
                                                    <img src="{{asset('assets/frontend/img/blog-img/9.jpg')}}" alt="">
                                                </div>
                                                <!-- Comment Content -->
                                            ...
                                            <ol class="children">
                                                <li class="single_comment_area">
                                                    <div class="comment-wrapper d-flex">
                                                        <!-- Comment Meta -->
                                                        <div class="comment-author">
                                                            <img src="{{asset('assets/frontend/img/blog-img/10.jpg')}}" alt="">
                                                        </div>
                                                        <!-- Comment Content -->
                                                        <div class="comment-content">
                                        ...
                                        <li class="single_comment_area">
                                            <div class="comment-wrapper d-flex">
                                                <!-- Comment Meta -->
                                                <div class="comment-author">
                                                    <img src="{{asset('assets/frontend/img/blog-img/11.jpg')}}" alt="">
                                                </div>
                                                <!-- Comment Content -->
                                                <div class="comment-content">
