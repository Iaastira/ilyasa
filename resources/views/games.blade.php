...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-section">
			<div class="container">
			          	...
			          	<div class="sport-team-wrap ftco-animate">
				          	...
				          	<div class="d-sm-flex mb-4">
					          	<div class="sport-team d-flex align-items-center">
				          			<div class="img logo" style="background-image: url(asset/frontend/images/team-1.jpg);"></div>
					          	...
					          	<div class="sport-team d-flex align-items-center">
				          			<div class="img logo order-sm-last" style="background-image: url(asset/frontend/images/team-2.jpg);"></div>
												<div class="text-center px-1 px-md-3 desc">
	          	...
	          	<div class="col-md-12">
	          		<div class="scoreboard scoreboard-2 slash">
			          	...
			          	<div class="sport-team-wrap ftco-animate">
				          	...
				          	<div class="d-sm-flex mb-4">
					          	<div class="sport-team d-flex align-items-center">
				          			<div class="img logo" style="background-image: url(asset/frontend/images/team-3.jpg);"></div>
												<div class="text-center px-1 px-md-3 desc">
													<h3 class="score win"><span>12</span></h3>
													<h4 class="team-name">Phoenix</h4>
												</div>
					          	...
					          	<div class="sport-team d-flex align-items-center">
				          			<div class="img logo order-sm-last" style="background-image: url(asset/frontend/images/team-4.jpg);"></div>
												<div class="text-center px-1 px-md-3 desc">
													<h3 class="score lost"><span>8</span></h3>
													<h4 class="team-name">Mighty Falcons</h4>
												</div>
	          	...
	          	<div class="col-md-12">
	          		<div class="scoreboard scoreboard-2 slash">
			          	...
			          	<div class="sport-team-wrap ftco-animate">
				          	...
				          	<div class="d-sm-flex mb-4">
					          	<div class="sport-team d-flex align-items-center">
				          			<div class="img logo" style="background-image: url(asset/frontend/images/team-5.jpg);"></div>
												<div class="text-center px-1 px-md-3 desc">
													<h3 class="score win"><span>12</span></h3>
													<h4 class="team-name">Phoenix</h4>
												</div>
					          	...
					          	<div class="sport-team d-flex align-items-center">
				          			<div class="img logo order-sm-last" style="background-image: url(asset/frontend/images/team-6.jpg);"></div>
												<div class="text-center px-1 px-md-3 desc">
													<h3 class="score lost"><span>8</span></h3>
													<h4 class="team-name">Mighty Falcons</h4>
												</div>
	          ...
	          <div class="row mt-5">
	            ...
	            <h2 class="mb-4">Latest Video</h2>
							<div class="img d-flex align-items-center justify-content-center py-5" style="background-image: url(asset/frontend/images/victory.jpg); width: 100%;">
	            ...
	            <div class="row">
	            	<div class="col-md-6 top-score pb-4 mb-1">
			    				<div class="img" style="background-image: url(asset/frontend/images/staff-1.jpg);"></div>
		    				...
		    				<div class="col-md-6 top-score pb-4 mb-1">
			    				<div class="img" style="background-image: url(asset/frontend/images/staff-2.jpg);"></div>
			    				<div class="text text-center">
			    					<h3 class="mb-0">David Scott</h3>
			    					<span class="score">12 games / 10 goals</span>
			    				</div>
		    				...
		    				<div class="col-md-6 top-score pb-4 mb-1">
			    				<div class="img" style="background-image: url(asset/frontend/images/staff-3.jpg);"></div>
			    				<div class="text text-center">
			    					<h3 class="mb-0">David Scott</h3>
			    					<span class="score">12 games / 10 goals</span>
			    				</div>
		    				...
		    				<div class="col-md-6 top-score pb-4 mb-1">
			    				<div class="img" style="background-image: url(asset/frontend/images/staff-4.jpg);"></div>
			    				<div class="text text-center">
			    					<h3 class="mb-0">David Scott</h3>
			    					<span class="score">12 games / 10 goals</span>
			    				</div>
		...
		<section class="ftco-subscribe img" style="background-image: url(asset/frontend/images/bg_2.jpg);">
      <div class="overlay">
        <div class="container">
