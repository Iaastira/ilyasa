...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('assets/frontend/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="{{ asset('assets/frontend/images/image_6.jpg') }}" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="{{ asset('assets/frontend/images/image_4.jpg') }}" alt="" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="{{ asset('assets/frontend/images/person_1.jpg') }}" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
		...
		<section class="ftco-subscribe img" style="background-image: url(assets/frontend/images/bg_2.jpg);">
      <div class="overlay">
        <div class="container">
